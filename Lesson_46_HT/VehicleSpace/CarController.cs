...
namespace VehicleSpace
{
	public class CarController : IVehicleController
	{
        ...
        private bool ChooseBrand(ref string choosenBrand)
        {
            ...
            if (int_brand_id < 0 || int_brand_id >= Car.carBrands.Count)
            {
                return false;
            }

            choosenBrand = Car.carBrands[int_brand_id];
            return true;
        }
        ...
        private bool ChooseModel(ref string choosenModel, string choosenBrand)
        {
            ...
            ArrayList choosenModelList = (ArrayList)Car.carModels[choosenBrand];
        ...
        public bool CreateVehicle(ref IVehicle vehicle)
        {
            ...
            if (!Car.CheckPatterns["Price"].IsMatch(current_price))
            {
                if (!Car.CheckPatterns["Mileage"].IsMatch(current_price))
                {
                    return false;
                }
            }
            ...
            if (!Car.CheckPatterns["Mileage"].IsMatch(current_mileage))
            {
                return false;
            }
        ...
        // AddVehicle function
        public void AddVehicle(IVehicle new_car)
        {
            VehiclesData.Add(new_car);
        }
        ...
        {
            IVehicle currentVehicle = new Car();
