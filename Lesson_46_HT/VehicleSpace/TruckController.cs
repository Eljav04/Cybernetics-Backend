...
namespace VehicleSpace
{
    public class TruckController : IVehicleController
    {
        ...
        private bool ChooseBrand(ref string choosenBrand)
        {
            ...
            if (int_brand_id < 0 || int_brand_id >= Truck.truckBrands.Count)
            {
                return false;
            }

            choosenBrand = Truck.truckBrands[int_brand_id];
            return true;
        }
        ...
        private bool ChooseModel(ref string choosenModel, string choosenBrand)
        {
            ...
            ArrayList choosenModelList = (ArrayList)Truck.truckModels[choosenBrand];
        ...
        public bool CreateVehicle(ref IVehicle vehicle)
        {
            ...
            if (!Truck.CheckPatterns["Price"].IsMatch(current_price))
            {
                if (!Truck.CheckPatterns["Mileage"].IsMatch(current_price))
                {
                    return false;
                }
            }
            ...
            if (!Truck.CheckPatterns["Mileage"].IsMatch(current_mileage))
            {
                return false;
            }
        ...
        // AddVehicle function
        public void AddVehicle(IVehicle new_truck)
        {
            VehiclesData.Add(new_truck);
        }
        ...
        {
            IVehicle currentVehicle = new Truck();
